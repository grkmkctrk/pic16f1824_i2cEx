...
void readCalibrationDatas(void){
    ...
    i2c_readDataBlock(0xEE, startPointOfCalibDatas, CalibDatas, 22);
...
uint16_t getUTemp(void){
    uint8_t write = 0x2E;
    uint8_t tempRaw[2] = {0};
    i2c_write1ByteRegister(0xEE, 0x74, write); _delay((unsigned long)((5)*(32000000/4000.0)));
    i2c_readDataBlock(0xEE, 0x76, tempRaw, 2);
    return (uint16_t) ((tempRaw[0] << 8) + tempRaw[1]);
}

double realTemp(void){
    UT = getUTemp();
    X1 = ((UT-AC6)*(AC5/(powf(2,15))));
...
uint32_t getUpress(uint8_t oss){
    ...
    I2C_Write1ByteRegister(0xEE, 0x74, write);
    switch(oss){
        case 0: _delay((unsigned long)((5)*(32000000/4000.0))); break;
        case 1: _delay((unsigned long)((8)*(32000000/4000.0))); break;
        case 2: _delay((unsigned long)((14)*(32000000/4000.0))); break;
        case 3: _delay((unsigned long)((26)*(32000000/4000.0))); break;
    }
    i2c_readDataBlock(0xEE, 0x76, pressRAW, 3);
...
double realPress(int oss){
 ...
 X3 = ((X1+X2)+2)/powf(2,2);
 B4 = AC4*(unsigned long)(X3+32768)/(powf(2,15));
 B7 = ((unsigned long)UP-B3)*(50000>>oss);
 if (B7<0x80000000) press = (B7*2)/B4;
 else press = (B7/B4)*2;
 X1 = (press/(powf(2,8)))*(press/(powf(2,8)));
 X1 = (X1*3038)/(powf(2,16));
 X2 = (-7357*press)/(powf(2,16));
 press = press + (X1+X2+3791)/(powf(2,4));
    return press;
}
